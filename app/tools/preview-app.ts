...
import { EXERCISES, MUSCLE_LABELS, EQUIPMENT_LABELS, MuscleGroup, Equipment, ALL_EQUIPMENT, getExerciseById } from '../src/data/exercises';
import { PATTERNS, PATTERN_GROUPS } from '../src/data/patterns';
import { commonMistakesFor, substitutionsFor, variationsOf } from '../src/data/exerciseRelations';
