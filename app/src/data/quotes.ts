...
export const QUOTES: Quote[] = [
  ...
  { id: 'ma_29', text: 'Be not as one that hath ten thousand years to live; death is nigh at hand.', author: 'Marcus Aurelius', source: 'Meditations', themes: ['mortality', 'perspective'] },
  { id: 'ma_30', text: 'Remember that all is opinion.', author: 'Marcus Aurelius', source: 'Meditations', themes: ['perspective', 'control'] },
  { id: 'ma_31', text: 'A man should be upright, not kept upright.', author: 'Marcus Aurelius', source: 'Meditations', themes: ['discipline', 'control'] },
  { id: 'ma_32', text: 'Death hangs over thee: whilst yet thou livest, be good.', author: 'Marcus Aurelius', source: 'Meditations', themes: ['mortality', 'discipline'] },
  { id: 'ma_33', text: 'You will find rest from vain fancies if you perform every act in life as though it were your last.', author: 'Marcus Aurelius', source: 'Meditations', themes: ['mortality', 'perspective', 'discipline'] },
  { id: 'ma_34', text: 'No state is sorrier than that of the man who keeps up a continual round.', author: 'Marcus Aurelius', source: 'Meditations', themes: ['perspective', 'habit'] },
  ...
  { id: 'ep_18', text: 'Some things are in our control and others not.', author: 'Epictetus', source: 'Enchiridion', themes: ['control'] },
  { id: 'ep_19', text: 'It is not he who gives abuse or blows who affronts, but the view we take of these things as insulting.', author: 'Epictetus', source: 'Enchiridion', themes: ['control', 'perspective'] },
  { id: 'ep_20', text: 'Everything has two handles, the one by which it may be carried, the other by which it cannot.', author: 'Epictetus', source: 'Enchiridion', themes: ['perspective', 'control'] },
  { id: 'ep_21', text: 'Freedom is not acquired by satisfying yourself with what you desire, but by destroying your desire.', author: 'Epictetus', source: 'Discourses', themes: ['discipline', 'control'] },
  ...
  { id: 'se_08', text: 'It is not the man who has too little that is poor, but the one who craves more.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['perspective'] },
  { id: 'se_09', text: 'What man can you show me who places any value on his time?', author: 'Seneca', source: 'Letters from a Stoic', themes: ['discipline', 'perspective'] },
  { id: 'se_10', text: 'Live among men as if God beheld you.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['discipline', 'control'] },
  { id: 'se_11', text: 'You need a change of soul rather than a change of climate.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['perspective', 'discipline'] },
  { id: 'se_12', text: 'A great pilot can sail even when his canvas is rent.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['adversity', 'endurance', 'effort'] },
  { id: 'se_13', text: 'He who does not wish to die cannot have wished to live.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['mortality'] },
  { id: 'se_14', text: 'It is quality rather than quantity that matters.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['discipline', 'effort'] },
  { id: 'se_15', text: 'Treat your inferiors as you would be treated by your betters.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['control', 'discipline'] },
  { id: 'se_16', text: 'Show me that the good in life does not depend upon life\'s length.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['mortality', 'perspective'] },
  { id: 'se_17', text: 'What is wisdom? Always desiring the same things.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['discipline', 'perspective'] },
  { id: 'se_18', text: 'Who is everywhere is nowhere.', author: 'Seneca', source: 'Letters from a Stoic', themes: ['discipline', 'habit'] },
];
