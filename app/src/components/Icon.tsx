...
export const ICON_PATHS = {
  ...
  trash:
    'M5,7 H19 M9,7 V5 C9,4.4 9.4,4 10,4 H14 C14.6,4 15,4.4 15,5 V7 ' +
    'M7,7 L8,19.5 C8,20.3 8.7,21 9.5,21 H14.5 C15.3,21 16,20.3 16,19.5 L17,7 ' +
    'M10,10.5 V17.5 M14,10.5 V17.5',
  ...
  settings:
    ...
    'M15,12 H17.5 M14.12,14.12 L16.24,16.24 M12,15 V17.5 M9.88,14.12 L7.76,16.24 ' +
    'M9,12 H6.5 M9.88,9.88 L7.76,7.76 M12,9 V6.5 M14.12,9.88 L16.24,7.76',
  palette:
