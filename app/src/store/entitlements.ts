...
import { isValidBetaCode } from '@/lib/betaCodes';
...
export const PRO_FEATURES: Record<ProFeature, { title: string; blurb: string }> = {
  ...
  import_workouts: {
    ...
    blurb: 'Snap a photo of a plan or paste it in — ATLAS reads it and turns it into a ready-to-run week, creating any missing exercises for you.',
  },
  more_routines: {
    title: 'More Routines',
...
interface EntitlementState {
  ...
  /** Offline beta-tester unlock — see src/lib/betaCodes.ts. Returns whether
   *  the code was valid; false leaves isPro untouched so the screen can show
