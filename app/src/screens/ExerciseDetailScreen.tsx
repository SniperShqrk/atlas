...
import { getExerciseById, MUSCLE_LABELS, EQUIPMENT_LABELS, CATEGORY_LABELS } from '@/data/exercises';
import {
  commonMistakesFor,
  patternInfoFor,
  substitutionsFor,
...
export default function ExerciseDetailScreen() {
  ...
  const substitutions = substitutionsFor(exercise, {
    allowed: equipmentFor(profile.equipmentAccess),
  });
          ...
          {substitutions.length > 0 && (
            <Card style={{ marginTop: spacing.lg }}>
              ...
              <Text style={styles.sectionNote}>
                ...
                {profile.equipmentAccess === 'full_gym' ? '' : ' — change it in Profile to see more'}.
              </Text>
