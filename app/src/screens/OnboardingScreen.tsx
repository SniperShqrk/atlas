...
// individual equipment checklist — see EQUIPMENT_OPTIONS in data/exercises.ts
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {step === 'about' && (
          <View>
            ...
            <Text style={styles.label}>EQUIPMENT — TAP EVERYTHING YOU HAVE</Text>
            <View style={[styles.row, styles.equipmentRow]}>
              {EQUIPMENT_OPTIONS.map((e) => {
                const on = profile.equipment.includes(e.value);
                return (
                  <Pressable
                    key={e.value}
                    onPress={() =>
                      setProfile({
                        equipment: on
                          ? profile.equipment.filter((x) => x !== e.value)
