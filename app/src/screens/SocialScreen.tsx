...
export default function SocialScreen() {
  ...
  // this guards SocialScreen itself in case anything ever navigates here
  // directly — no session, or a session that never finished picking a
  // username, both bounce back to the gate instead of rendering with a
  // missing/undefined profile.
  useEffect(() => {
    if (!session || !profile?.username) navigation.replace('Auth');
